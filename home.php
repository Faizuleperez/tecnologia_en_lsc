                    ...
                    <form action="back/registro.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="password" class="form-control" name="pass" id="inputcontra"
                                 pattern ="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$" 
                                  onchange ="this .setCustomValidity(this.validity.patternMismatch ? 'Debe contener entre 8 y 16 caracteres:(diditos,minusculas, mayusculas, y simbolo)' : ''); 
                                  if (this.checkValidity()) form.imputcontra2.pattern =  this.value;"required>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputcontra2">Confirme Contraseña </label>
                                <input type="password" class="form-control" name="pass2" id="inputcontra2" 
                                 pattern ="^(?=.*\d)(?=.*[\u0021-\u002b\u003c-\u0040])(?=.*[A-Z])(?=.*[a-z])\S{8,16}$"
                                 onchange ="this.setCustomValidity(this.validity.patternMismatch ? 'Ingresa la misma contraseña' :''); "required>
                        ...
                        <button name="register_btn" type="submit"id='enviar' class="btn_login">Registrate</button>
